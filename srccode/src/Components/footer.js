...
function Footer() {
  return (
    <div className='footer'>
        <h2 className='heading2'>Shortly</h2>
        <div className='links'>
            <div className="part">
                <h4 className='heading3'>Features</h4>
                <p className='about3'>Link Shortening</p>
                <p className='about3'>Branded Links</p>
                <p className='about3'>Analytics</p>
            </div>
            <div className="part">
                <h4 className='heading3'>Resources</h4>
                <p className='about3'>Blog</p>
                <p className='about3'>Developers</p>
                <p className='about3'>Support</p>
            </div>
            <div className="part">
                <h4 className='heading3'>Company</h4>
                <p className='about3'>About</p>
                <p className='about3'>Our Team</p>
                <p className='about3'>Careers</p>
                <p className='about3'>Contract</p>
            </div>
